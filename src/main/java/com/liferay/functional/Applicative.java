...
interface Applicative<AP, T> extends Functor<T> {
	...
	static <AP, A, B, C, D, T> Applicative<AP, T> lift(
	...
	static <AP, A, B, C, D, E, T> Applicative<AP, T> lift(
	...
	static <AP, A, B, C, D, E, F, T> Applicative<AP, T> lift(
	...
	static <AP, A, B, C, D, E, F, G, T> Applicative<AP, T> lift(
	...
	static <AP, A, B, C, D, E, F, G, H, T> Applicative<AP, T> lift(
